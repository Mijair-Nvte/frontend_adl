...
import { Avatar, AvatarImage, AvatarFallback } from "@/components/calendarui/ui/avatar";
import {
  Select,
  SelectItem,
  SelectContent,
...
import { AvatarGroup } from "@/components/calendarui/ui/avatar-group";

export function UserSelect() {
  const { users, selectedUserId, filterEventsBySelectedUser } = useCalendar();

  return (
    <Select value={selectedUserId || "all"} onValueChange={filterEventsBySelectedUser}>
