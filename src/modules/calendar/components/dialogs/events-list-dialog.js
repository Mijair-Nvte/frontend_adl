...
import { Dialog, DialogContent, DialogTrigger, DialogHeader, DialogTitle } from "@/components/calendarui/ui/dialog";
...
export function EventListDialog({ date, events, maxVisibleEvents = 3, children }) {
