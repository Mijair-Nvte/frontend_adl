...
import { DayPicker } from "@/components/calendarui/ui/day-picker";
        ...
        <div>
          ...
          <div className="relative z-20 flex border-b">
            ...
            <span className="flex-1 border-l py-2 text-center text-xs font-medium text-t-quaternary">
             {format(selectedDate, "EE", { locale: es })}

              <span className="font-semibold text-t-secondary ml-1">{format(selectedDate, "d")}</span>
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-3">
          {currentEvents.length > 0 ? (
            <div className="flex items-start gap-2 px-4 pt-4">
              ...
              <p className="text-sm font-semibold text-t-secondary">Eventos de hoy</p>
            </div>
          ) : (
