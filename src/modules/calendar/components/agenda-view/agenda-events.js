...
import { Avatar, AvatarFallback, AvatarImage } from "@/components/calendarui/ui/avatar";
...
import {
  ...
  CommandItem,
  CommandList,
} from "@/components/calendarui/ui/command";
...
export const AgendaEvents = () => {
  ...
  const eventsByMode = Object.groupBy(
    useGetEventsByMode(events),
    (event) => {
