...
import { buttonVariants } from "@/components/calendarui/ui/button";
import { cn } from "@/lib/utils";

function DayPicker({ className, classNames, showOutsideDays = true, ...props }) {
  return (
    <ReactDayPicker
      ...
      className={cn("p-3", className)}
       classNames={{
        ...
        day_selected: "bg-indigo-500 text-white dark:text-black dark:hover:!text-white",
        day_today: "text-indigo-500 ",
